...
namespace XStory.ViewModels
{
    public class SettingsPage3ViewModel : BaseViewModel
    {
        ...
        #region --- Ctor ---
        public SettingsPage3ViewModel(INavigationService navigationService, BL.Web.XStory.Contracts.IServiceCategory serviceCategoryWeb, BL.SQLite.Contracts.IServiceCategory serviceCategorySQLite)
