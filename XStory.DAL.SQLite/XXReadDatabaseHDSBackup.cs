...
{
	public class XXReadDatabaseHDSBackup : IXXReadDatabaseHDSBackup
	{
		public SQLiteAsyncConnection Database;


		public XXReadDatabaseHDSBackup()
		{
			Database = new SQLiteAsyncConnection(Constants.DatabasePathHDSBackup, Constants.Flags);
